...
class Notification(Component, TemporaryDrawable):
    notifications = {
        "me_turn": ("notif_me_turn", "Your turn!"),
        "op_turn": ("notif_op_turn", "Opponent's turn"),
        "start": ("notif_me_coin", "You will go first."),
        "op_start": ("notif_op_coin", "Your opponent will go first."),
        "scoia_start": ("notif_scoiatael", "You will go first."),
        "scoia_op_start": ("notif_scoiatael", "Your opponent will go first."),
        "op_scoia_start": ("notif_scoiatael", "Opponent used the Scoia'tael faction perk\nto go first."),
        "op_scoia_op_start": ("notif_scoiatael", "Opponent used the Scoia'tael faction perk\nfor you to go first."),
        "round_start": ("notif_round_start", "Round start"),
        "pass_op": ("notif_round_passed", "Your opponent has passed"),
        "pass": ("notif_round_passed", "Round passed"),
        "draw_round": ("notif_draw_round", "The round ended in a draw."),
        "lose_round": ("notif_lose_round", "Your opponent won the round."),
        "win_round": ("notif_win_round", "You won the round!"),
        ...
        "nilfgaard_ability": ("notif_nilfgaard",
                             "Nilfgaardian Empire faction ability triggered -\nNilfgaard wins the tie."),
    ...
    def draw(self):
        ...
        self.draw_text(self.text, x, y, u.COLOR_GOLD, self.font, centery=True)
    ...
    def _draw_text_lines(self, lines, x, y, color=u.COLOR_WHITE, font0=u.CINZEL_30, font1=None, spacing=5,
        ...
        super()._draw_text_lines(lines, x, y, color, font0, spacing=5, centery=True, **kwargs)